...
public class VideoController {
    ...
    // Helper: populate shared model attributes (navbar data)
    ...
    public ModelAndView index(Authentication authentication) {
        ...
        // Ensure all users have yid (migration)
    ...
    public org.springframework.http.ResponseEntity<?> getVideo(
        ...
        // 1. Try header first (customized extension download)
        ...
        // 2. Fallback to active Session authentication
    ...
    public org.springframework.http.ResponseEntity<byte[]> downloadExtension(
        ...
        // Dynamically determine the application's base URL (handles reverse proxies in production)
